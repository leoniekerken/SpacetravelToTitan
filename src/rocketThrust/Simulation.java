...
public class Simulation {
    ...
    public static void main(String[] args) {
        ...
        // pf is not correct at the moment, this is the initial position of titan in 2020
        // pf needs to be the position of titan on the date we wants to reach it
        ...
        Vector3dInterface pk = p0;                  // Current position of the probe (Initialized with the starting position of the probe)

        Vector3dInterface g = new Vector3d();       // pf - pk (Should be as close to a zero vector as possible

        System.out.println("PROBE SIMULATION");
        System.out.println();
        System.out.println();
        ...
        // until we are close to Titan keep updating data
